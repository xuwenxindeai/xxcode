...
exports.analyzeImageTool = exports.screenshotAnalyzeTool = exports.visionTool = exports.takeScreenshotTool = void 0;
...
exports.visionTool = {
    ...
    async execute(args, cwd) {
        try {
            ...
            const reply = await llm.chatStreaming(args.model || 'qwen3.5-plus', messages, [], () => { });
            return {
                success: true,
...
exports.screenshotAnalyzeTool = {
    ...
    async execute(args) {
        try {
            ...
            const reply = await llm.chatStreaming('qwen3.5-plus', messages, [], () => { });
            // 清理临时文件
            try {
