...
exports.perfTool = exports.logTool = exports.curlTool = exports.portCheckTool = exports.pingTool = exports.killTool = exports.psTool = void 0;
...
exports.psTool = {
    ...
    async execute(args, _cwd) {
        try {
            ...
            if (lines.length === 0)
                return { success: true, output: '(无进程)' };
...
//# sourceMappingURL=sysops.js.map